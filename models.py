...
class VehicleExpense(db.Model):
    ...
    casco = db.Column(db.Float, default=0)
    rca = db.Column(db.Float, default=0)
    impozite = db.Column(db.Float, default=0)
    roviniete = db.Column(db.Float, default=0)
    itp = db.Column(db.Float, default=0)
